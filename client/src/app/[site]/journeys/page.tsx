...
export default function JourneysPage() {
  const t = useTranslations("journeysPage");
      ...
      <div className="container mx-auto p-2 md:p-4">
        ...
        <div className="flex items-center gap-6 my-2">
          <div className="flex items-center gap-3 w-[180px]">
            <span className="text-sm text-neutral-600 dark:text-neutral-300 whitespace-nowrap">{t("{count} steps", { count: steps })}</span>
            <Slider
              value={[steps]}
          ...
          <div className="flex items-center gap-3 w-[200px]">
            <span className="text-sm text-neutral-600 dark:text-neutral-300 whitespace-nowrap">
              {t("{count} journeys", { count: maxJourneys })}
            </span>
            <Slider
              value={[maxJourneys]}
            ...
            <div className="flex flex-col gap-1 mb-4 mt-4">
              <div className="flex gap-1">
                {Array.from({ length: steps }, (_, i) => (
                  ...
                  >
                    <span className="ml-2 whitespace-nowrap text-neutral-700 dark:text-neutral-200">{t("Step {number}", { number: i + 1 })}</span>
