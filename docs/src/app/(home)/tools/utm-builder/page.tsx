...
const educationalContent = (
  <>
    ...
    <ul className="space-y-2 text-neutral-700 dark:text-neutral-300 mb-6">
      ...
      <li>
        <code className="text-sm font-mono text-emerald-600 dark:text-emerald-400">utm_medium</code> - How they got there
        (cpc, email, social, organic)
      </li>
      <li>
        <code className="text-sm font-mono text-emerald-600 dark:text-emerald-400">utm_campaign</code> - Which campaign it
        belongs to (summer_sale, product_launch)
      </li>
      <li>
        <code className="text-sm font-mono text-emerald-600 dark:text-emerald-400">utm_term</code> - Paid search keywords
        (optional)
      </li>
      <li>
    ...
    <p className="text-neutral-700 dark:text-neutral-300 mb-4">
      <code className="text-xs font-mono">https://example.com?utm_source=google&utm_medium=cpc&utm_campaign=summer_sale&utm_term=running_shoes</code>
    </p>
    ...
    <ul className="space-y-2 text-neutral-700 dark:text-neutral-300 mb-6">
      <li>
        <strong>Use Consistent Formatting:</strong> Always use lowercase letters and underscores instead of spaces. This ensures consistent data grouping
        in your analytics. Good: summer_sale, facebook_ads, email_newsletter | Bad: Summer Sale, Facebook Ads, Email Newsletter
      </li>
      <li>
        <strong>Be Descriptive but Concise:</strong> Use names that clearly identify the campaign or source without being overly long. Short, specific
        names are easier to remember and less prone to typos.
      </li>
      <li>
        <strong>Establish a Naming Convention:</strong> Create a standard UTM naming scheme for your organization and document it. This prevents duplicate or
        conflicting parameter values. Example scheme: campaign = [season]_[product], source = [channel], medium = [type]
      </li>
      <li>
        <strong>Never Use Spaces or Special Characters:</strong> Spaces and special characters can cause encoding issues. Stick to alphanumeric characters and
        underscores.
      </li>
    </ul>
    ...
    <ul className="space-y-2 text-neutral-700 dark:text-neutral-300 mb-6">
      <li>
        <strong>Email Marketing:</strong> Track which emails drive the most traffic. Use utm_source=newsletter, utm_medium=email, and create
        unique campaign names for each send.
      </li>
      <li>
        <strong>Social Media Campaigns:</strong> Measure performance across platforms. Use utm_source=facebook/twitter/linkedin, utm_medium=social, and
        track A/B tests with utm_content.
      </li>
      <li>
        <strong>Paid Search Ads:</strong> Track Google Ads and Bing campaigns. Use utm_source=google, utm_medium=cpc, and utm_term for your
        keywords to optimize bidding.
      </li>
      <li>
        <strong>Affiliate & Referral Programs:</strong> Monitor performance by partner. Use utm_source=[partner_name], utm_medium=affiliate, and
        utm_content=[unique_id] per partner.
      </li>
      <li>
        <strong>Offline to Online Tracking:</strong> Include UTM parameters in offline marketing materials. QR codes, print ads, and events can all drive
        trackable traffic.
      </li>
      <li>
        <strong>A/B Testing Ads:</strong> Compare different ad creatives or messaging. Use utm_content to differentiate versions and measure
    ...
    <ul className="space-y-2 text-neutral-700 dark:text-neutral-300 mb-6">
      <li>
        <strong>Inconsistent Parameter Values:</strong> Using "Facebook" sometimes and "facebook" other times causes data to be split into separate analytics
        rows. Always use consistent casing and formatting.
      </li>
      <li>
        <strong>Omitting Required Parameters:</strong> While technically you can have partial UTM parameters, missing utm_source, utm_medium, or utm_campaign
        reduces your tracking insight. Always fill at least these three.
      </li>
      <li>
        <strong>Using Spaces and Special Characters:</strong> Spaces become %20 in URLs, and special characters can cause encoding issues. Stick to letters,
        numbers, hyphens, and underscores.
      </li>
      <li>
        <strong>Forgetting to Tag All Links:</strong> If you only tag some of your marketing links, you'll get incomplete data. Create a process to tag
        every single campaign link.
      </li>
      <li>
        <strong>Not Documenting Your Scheme:</strong> Without documented naming conventions, your team will create inconsistent UTM parameters. Create and
        share a style guide.
      </li>
    </ul>
    ...
    <ol className="space-y-2 text-neutral-700 dark:text-neutral-300 mb-6">
      ...
      <li>
        <strong>Fill Required Fields:</strong> Set your utm_source, utm_medium, and utm_campaign. These three are essential for proper tracking.
      </li>
      <li>
        <strong>Add Optional Parameters:</strong> Use utm_term for keywords and utm_content to differentiate ads within the same campaign.
      </li>
      <li>
        <strong>Copy Your UTM URL:</strong> Click the Copy button to copy your fully formed URL with all parameters included.
      </li>
      <li>
        <strong>Use in Your Campaigns:</strong> Paste the URL in your marketing channels (emails, ads, social posts, etc.) and track the results.
      </li>
    </ol>
  </>
);
...
const faqs = [
  {
    ...
    answer: "UTM (Urchin Tracking Module) parameters are tags added to URLs that help you track the effectiveness of your marketing campaigns in analytics tools like Rybbit, Google Analytics, and others. They tell you exactly where your traffic is coming from and how your campaigns perform.",
  },
  {
    question: "What are the required UTM parameters?",
    answer: "The three required parameters are: utm_source (identifies the source like google or newsletter), utm_medium (identifies the medium like cpc or email), and utm_campaign (identifies the specific campaign like summer_sale).",
  },
  {
    question: "How do I track UTM links with Rybbit?",
    answer: "Once you have Rybbit installed on your website, UTM parameters are automatically tracked. You can view your campaign performance in your Rybbit dashboard under the UTM section.",
  },
  {
    question: "What are optional UTM parameters?",
    answer: "utm_term is used for tracking paid search keywords, while utm_content helps differentiate between different ads or links within the same campaign. These are optional but useful for deeper campaign analysis and A/B testing.",
  },
  {
    question: "What naming conventions should I follow?",
    answer: "Use lowercase letters and underscores instead of spaces (e.g., summer_sale, not Summer Sale). Be consistent across campaigns so data is properly grouped in analytics. Avoid special characters and keep names descriptive but concise.",
  },
];
